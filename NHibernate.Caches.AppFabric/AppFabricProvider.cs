...
namespace NHibernate.Caches.AppFabric
{
    ...
    public class AppFabricProvider : ICacheProvider
    {
        ...
        public void Start(IDictionary<string, string> properties)
        {
            ...
            var prefixName = "cache.region_prefix";
            if (properties.ContainsKey(prefixName))
            {
                var prefix = properties[prefixName];
                AppFabricProviderSettings.Settings.RegionPrefix = prefix;
            }
